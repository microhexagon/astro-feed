            ...
            >
                ...
                <div>
                    ...
                    <p className="text-white text-base sm:text-lg md:text-xl mt-4 leading-relaxed drop-shadow-lg">
                        <span className="block">Your gateway to the wonders of space exploration. Discover the latest astronomy news,breathtaking images, </span>
                        <span className="block pl-0 sm:pl-8 md:pl-16">and upcoming launch schedules.</span>
                    </p>
                    <div className="flex justify-center m-3 drop-shadow-lg">
                        <button className="flex justify-center items-center bg-blue-400  hover:bg-blue-600  text-white rounded-lg h-10 w-28 ">Get Started</button>
                    </div>
                </div>
            </section>
    )
